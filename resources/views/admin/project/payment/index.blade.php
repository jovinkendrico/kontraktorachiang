    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">List Payment
                </h1>
                <!--end::Title-->
                <!--begin::Separator-->
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                            ...
                                            @if (is_null($payment->deleted_at))
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('admin.project.payment.show', $payment->id) }}"
                                                        class="menu-link px-3">Show</a>
                                                </div>
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('admin.project.payment.edit', $payment->id) }}"
                                            ...
                                            @else
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('admin.project.payment.index', $payment->id) }}"
                                                        class="menu-link px-3">Show</a>
                                                </div>
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('admin.project.payment.restore', $payment->id) }}"
